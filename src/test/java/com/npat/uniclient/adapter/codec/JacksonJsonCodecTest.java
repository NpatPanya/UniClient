...
public final class JacksonJsonCodecTest {
 ...
 public static void main(String[] args) {
  ...
  assertEquals("00",decoded.getRspCode(),"response code"); assertEquals("Ada",decoded.getResponseEntity().name,"DTO decoding");
  ...
  assertEquals("not-json",malformed.getRawPayload(),"raw preserved on decode failure"); if(malformed.getErrorMessage()==null)throw new AssertionError("decode error must be retained");
 }
 public static final class Item { public String name; public Item(){} public Item(String name){this.name=name;} }
 static void assertEquals(Object e,Object a,String l){if(e==null?a!=null:!e.equals(a))throw new AssertionError(l+" expected="+e+" actual="+a);}
}