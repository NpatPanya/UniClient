...
public final class UniClient implements ClientFacade {
    ...
    public UniClient(AdapterRegistry adapterRegistry) {
        this(adapterRegistry, null);
    }

    public UniClient(AdapterRegistry adapterRegistry, JsonCodec jsonCodec) {
    ...
    public <R extends APIResponse<?>> R send(APIRequest<?, R> request) {
        return (R) adapterRegistry.send(Objects.requireNonNull(request, "request"), jsonCodec);
    }
}